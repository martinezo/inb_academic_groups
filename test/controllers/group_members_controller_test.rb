...
class GroupMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_member" do
    assert_difference('GroupMember.count') do
      post group_members_url, params: { group_member: { academic_career_en: @group_member.academic_career_en, academic_career_es: @group_member.academic_career_es, catalogs_member_type_id: @group_member.catalogs_member_type_id, catalogs_status_id: @group_member.catalogs_status_id, current_position_en: @group_member.current_position_en, current_position_es: @group_member.current_position_es, current_workplace: @group_member.current_workplace, email: @group_member.email, firstname: @group_member.firstname, group_id: @group_member.group_id, lastname: @group_member.lastname, phone_numbers: @group_member.phone_numbers, photo_file_name: @group_member.photo_file_name, research_photo_descr_en: @group_member.research_photo_descr_en, research_photo_descr_es: @group_member.research_photo_descr_es, research_photo_file_name: @group_member.photo_res_file_name, research_interest_es: @group_member.research_interest_es, research_interests_en: @group_member.research_interests_en } }
    end
  ...
  test "should update group_member" do
    patch group_member_url(@group_member), params: { group_member: { academic_career_en: @group_member.academic_career_en, academic_career_es: @group_member.academic_career_es, catalogs_member_type_id: @group_member.catalogs_member_type_id, catalogs_status_id: @group_member.catalogs_status_id, current_position_en: @group_member.current_position_en, current_position_es: @group_member.current_position_es, current_workplace: @group_member.current_workplace, email: @group_member.email, firstname: @group_member.firstname, group_id: @group_member.group_id, lastname: @group_member.lastname, phone_numbers: @group_member.phone_numbers, photo_file_name: @group_member.photo_file_name, research_photo_descr_en: @group_member.research_photo_descr_en, research_photo_descr_es: @group_member.research_photo_descr_es, photo_res_file_name: @group_member.photo_res_file_name, research_interest_es: @group_member.research_interest_es, research_interests_en: @group_member.research_interests_en } }
